  ...
  return (
    <Card title="Optimization Settings">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <label className="mb-1 block text-sm font-medium">Optimization Model</label>
          <select
        ...
        <div>
          <label className="mb-1 block text-sm font-medium">Expected Return Model</label>
          <select
            value={returnModel}
      ...
      <div className="mt-4">
        <label className="mb-1 block text-sm font-medium">Risk Tolerance: {riskTolerance}%</label>
        <input
          type="range"
          min="0"
          max="100"
